...
namespace AvvaMobile.Core.Utilities.PushNotification
{
    public class PushNotificationService : BasePushNotificationService, IPushNotificationService
    {
        ...
        public PushNotificationSendResult Send(string userPushID, string message)
        {
            return Send(new List<string> { userPushID }, null, message);
        }
        public PushNotificationSendResult Send(List<string> userPushIDs, string message)
        {
            return Send(userPushIDs, null, message);
        }

        public PushNotificationSendResult Send(string userPushID, string title, string message)
        {
            return Send(new List<string> { userPushID }, title, message);
        }

        public PushNotificationSendResult Send(string userPushID, string title, string message, dynamic data)
        {
            return SendAsync(new List<string> { userPushID }, title, message, data);
        }

        public PushNotificationSendResult Send(List<string> userPushIDs, string title, string message, dynamic data = null)
        {
            string appID = _appSettingsKeys.OneSignal_AppID;
            string apiKey = _appSettingsKeys.OneSignal_APIKey;
            var pusNotificationResult = SendNotification(appID, apiKey, userPushIDs, title, message, data);
            return pusNotificationResult;
        }
    }
    ...
    public class BasePushNotificationService
    {
        ...
        public PushNotificationSendResult SendNotification(string appID, string apiKey, List<string> userPushIDs, string title, string message, dynamic data = null)
        {
            var result = new PushNotificationSendResult();
    ...
    public interface IPushNotificationService
    {
        ...
        PushNotificationSendResult Send(List<string> userPushIDs, string message);
        PushNotificationSendResult Send(List<string> userPushIDs, string title, string message, dynamic data = null);
        PushNotificationSendResult Send(string userPushID, string message);
        PushNotificationSendResult Send(string userPushID, string title, string message, dynamic data = null);
    }
}